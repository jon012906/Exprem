...
struct AppTheme {
    ...
    // MARK: Status Colors
    let statusExpiredSoon: Color
    let statusExpiredSoonBg: Color
    ...
    static let light = AppTheme(
        ...
        statusExpiredSoon: Color(red: 0.851, green: 0.467, blue: 0.024),
        statusExpiredSoonBg: Color(red: 0.996, green: 0.953, blue: 0.78),
    ...
    static let dark = AppTheme(
        ...
        statusExpiredSoon: Color(red: 0.98, green: 0.737, blue: 0.259),
        statusExpiredSoonBg: Color(red: 0.263, green: 0.188, blue: 0.067),
